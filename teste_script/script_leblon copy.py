...
def main():
    ...
    lista_tools_kpi = [
        ...
        tools.calcular_tia, tools.calcular_iavlit, tools.calcular_pcv, tools.calcular_ioalo,
        tools.analisar_evolucao_kpi
    ]
...
2. Para TODAS AS OUTRAS PERGUNTAS (Análise geral, contagens, somas, listagens, rankings):
   ...
   - Analise os nomes das colunas abaixo para entender onde estão os dados.
    ...
    - MANT001 = Detalhes sobre a abertura de chamado quando é realizada uma manutenção, incluindo serviço da manutenção (representado pelo início do valor de MANT001[Serviço]).
    - MANT002 = Detalhes técnicos do trabalho realizado, como tipo, categoria, classe, turno e tempo de duração (minutos) e colaborador responsável pela manutenção.
