...
def realizar_join(
    ...
    # 2. Remover '.0' do final da string caso exista (normalização)
...
📏 REGRAS ABSOLUTAS
1. Interprete a pergunta pelo significado, mesmo com termos diferentes, no plural, no singular, abreviações ou informais. Reconheça sinônimos e variações e associe sempre o conceito à coluna existente mais compatível. Nunca crie colunas novas.
